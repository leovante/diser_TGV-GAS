...
public class NetworkGasImpl implements Gas {
    private final double CH4 = 0.965;
    private final double C2H6 = 0.0187;
    private final double C3H8 = 0.006;
    private final double C4H10 = 0.001;
    private final double C5H12 = 0.0;
    private final double N2 = 0.0067;
    private final double CO2 = 0.00134;
    ...
    private final double other = 0.00126;
